      ...
      <div class="row">
        ...
        >
          <div class="cart-header">
            <h1>Shopping Bag (<span v-text="cartCount" />)</h1>
            <div class="clearfix" />
          </div>
        </div>
        <div
          ...
          >
            <div class="cart-content w-full sm:w-2/3">
              <div
                ...
                :key="product.key"
                class="cart-item py-4 mr-4"
              >
                <div class="image-wrapper w-1/4 sm:w-1/5">
                  <a
                    v-show="product.image_medium"
                    :href="product.link"
                  >
                    <img
                ...
                <div class="item-details w-3/4 sm:w-4/5 h-full">
                  ...
                  <div class="item-row">
                    ...
                    >
                      <span
                        class="original-price"
                        v-text="product.compare_at_price"
                      />
                      <span
                        class="current-price"
                        v-text="product.price"
              ...
              <div
                v-show="hasSubscriptionC"
                class="product-name my-8"
              >
                <small>
                  {{ subDisclaimerC }}
                </small>     
              ...
              <div class="recommended-products py-4 mr-4">
                <div v-if="recProdHeading" class="recommended-header">
                  {{ recProdHeading }}
                </div>
                <div
                  ...
                  <div class="summary__header py-2">
                    <div class="subtotal py-2">
                      ...
                      <span
                        ...
                        v-text="autoDiscountQualified ? cartEstimatedSubtotal : cartPrice"
                      />
                    </div>
                    <div class="atc__info py-2 capitalize">
                  ...
                  <div class="summary__cta">
                    <div class="atc__container">
                      <button
                        ...
                        class="flex to-checkout button-main-big dark-green-fill rounded-full py-3 px-6 flex justify-center items-center"
        ...
        <div
          v-show="isEmptyCart()"
          class="w-full text-center empty-cart-text"
        >
...
<script>
  ...
  export default {
    ...
    props: { recProdHeading: { type: String, default: "We also recommend" }, subDis: { type: String, default: "" } },
    data: function () {
      return {
